        ...
        <section className="bg-neutral text-neutral-content" id="demo">
            <div class="py-24 max-md:px-8 max-w-3xl mx-auto">
                ...
                <div class="relative max-sm:-mx-8 mb-16">
                    ...
                    <div class="relative w-full aspect-video overflow-hidden sm:rounded-lg">
                        <iframe class="absolute inset-0 w-full h-full" src="https://check-inplus.s3.ap-south-1.amazonaws.com/Chec-in+Plus+Admin+Module+Small_Video.mp4"
                            title="ShipFast tutorial" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                            allowfullscreen="" muted>
                        </iframe>
                    </div>
                </div>
                <div class="space-y-4 max-w-md mx-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 fill-white" viewBox="0 0 35 30"
                        fill="none">
                    ...
                    <p class="md:text-lg leading-relaxed">
                        Its a simple app but does what it says. Maintain visit records automatically.
                    </p>
                    <div class="flex items-center gap-2">
                        {/* <img
                            ...
                            height="48"
                            decoding="async"
                            src="/_next/static/media/yifan.d4b261ef.jpeg"
                            srcset="/_next/static/media/yifan.d4b261ef.jpeg 1x, /_next/static/media/yifan.d4b261ef.jpeg 2x"
